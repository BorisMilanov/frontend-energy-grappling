        ...
        <Content style={{ marginTop: 64 }}>
          ...
          >
            ...
            <TrainerProfile
              ...
              experience="5 години"
              bio="Синан Асенов е треньор и състезател в Energy Grappling Троян. Той помага на всеки трениращ да изгражда стабилни основи и увереност на татамито. Доказан състезател с набор от много състезания зад гърба си. Същевременно предава знанията си на новите поколения на бойните изкуства. Работи с практикуващи от начинаещи нива и подкрепя развитието им в бразилското жиу-жицу."
            ...
            <TrainerProfile
              ...
              role="Треньор и състезател · Energy Grappling Троян"
              experience="5 години"
              bio="Джани Асенов е треньор и състезател в Energy Grappling Троян. Той се доказъл като добър състезател на национално ниво и продължава да се развива активно в спорта, като същевременно предава знанията си на новите поколения на бойните изкуства. Работи с практикуващи от начинаещи нива и подкрепя развитието им в бразилското жиу-жицу."
