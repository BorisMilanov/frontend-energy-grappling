        ...
        <Row gutter={[48, 40]} align="middle" justify="center">
          ...
          <Col xs={24} sm={24} md={16}>
            ...
            >
              ...
              {/* Bio */}
              <Paragraph style={{ fontSize: 16, color: '#333', lineHeight: 2, marginBottom: 0, letterSpacing: '0.01em' }}>
                Димитър Николов е главният  треньор и основател на Energy Grappling и страстен практик на бразилско жиу жицу с над 10 години опит.
              
                С уникален подход и непреклонен дух, той завоюва множество турнирни победи в България и Европа.<br />
